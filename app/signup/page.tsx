...
import { signUpWithEmail, signInWithGoogle, updateCurrentUserPlan } from '../../lib/firebase';
...
export default function SignUpPage() {
  ...
  const handleGoogleSignUp = async () => {
    ...
    try {
      ...
      setError(getAuthErrorMessage(error.code) || 'Failed to sign up. Please try again.');
      setIsLoading(false);
    }
  };
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <h2 className="mt-6 text-center text-3xl font-bold tracking-tight text-gray-900">
          {showPlanSelection ? (isGoogleSignup ? 'Choose Your Plan' : 'Choose Your Plan') : 'Create your account'}
        </h2>
        <p className="mt-2 text-center text-sm text-gray-600">
          {showPlanSelection ? (isGoogleSignup ? 'Select the plan that best fits your needs to complete your account setup' : 'Select the plan that best fits your needs') : 'Start building your WhatsApp AI chatbots today'}
        </p>
      </div>
        ...
        <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
          <div className="space-y-6">
            ...
            {!showPlanSelection ? (
              <>
                {/* Email/Password Form */}
                <form onSubmit={(e) => { e.preventDefault(); handleContinueToPlanSelection(); }} className="space-y-4">
                  <div>
        ...
        <div className="bg-white py-6 px-4 shadow sm:rounded-lg sm:px-10">
          ...
          <div className="space-y-3">
            <div className="flex items-center">
              ...
              <span className="text-sm text-gray-600">Create unlimited AI chatbots</span>
            </div>
            <div className="flex items-center">
              <svg className="h-5 w-5 text-green-500 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7" />
              </svg>
              <span className="text-sm text-gray-600">Connect via QR code to WhatsApp</span>
            </div>
            <div className="flex items-center">
              <svg className="h-5 w-5 text-green-500 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7" />
            ...
            <div className="flex items-center">
              ...
              <span className="text-sm text-gray-600">Free trial with no credit card required</span>
            </div>
          </div>
        </div>
      </div>
